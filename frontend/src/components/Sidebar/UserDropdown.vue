...
const clearDemoDataConfirmation = () => {
	$dialog({
		...
		message: __(
			'Are you sure you want to clear the demo data? This would delete the course "A guide  to Ace It Up" along with all its associated data. This action cannot be undone.'
		),
		actions: [
			{
				label: __('Confirm'),
