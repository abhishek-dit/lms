	...
	course.update(
		{
			...
			"short_introduction": "Learn the basics of Ace It Up and how to get started with your very first course.",
			"image": "/assets/lms/images/course_card.jpeg",
		}
	)

	course.description = """
		This course will cover the fundamentals of Ace It Up, including how to create and manage courses, enroll students, and track progress. You will learn about the following key features of the app:
		<br>
		<h3>Key Features</h3>
		<br>
...
def create_quiz():
	...
	questions.append(
		create_quiz_questions(
			"What is Ace It Up primarily used for?",
			"Project Management",
			False,
			"Learning Management",
			True,
	...
	questions.append(
		create_quiz_questions(
			"Which of the following can be added to a course in Ace It Up?",
			"Lessons",
			True,
			"Issues",
			False,
	...
	questions.append(
		create_quiz_questions(
			"What is the top-level structure in Ace It Up?", "Chapter", False, "Course", True
		)
	)
	questions.append(
		create_quiz_questions("Can you create quizzes in Ace It Up?", "Yes", True, "No", False)
	)
	questions.append(
		create_quiz_questions(
	...
	questions.append(
		create_quiz_questions("Can you track learner progress in Ace It Up?", "Yes", True, "No", False)
	)
	questions.append(
		create_quiz_questions(
			"What is the purpose of a batch in Ace It Up?",
			"To group learners",
			True,
	...
	questions.append(
		create_quiz_questions(
			"How can you create custom certificates in Ace It Up?",
...
def create_reviews(course, student):
	...
	review.rating = 0.8
	review.review = "This is a great course to get started with Ace It Up. The content is well-structured and easy to follow."
	review.save()
		...
		"blocks": [
			{
				...
				"type": "paragraph",
				"data": {
					"text": "Ace It Up allows you to embed videos in lessons using popular video hosting platforms."
				},
			},
			{
				"id": "1ooWPn5Zmq",
				"type": "paragraph",
				"data": {
					"text": "You don't need to upload videos directly into Ace It Up - simply copy the video URL from your preferred provider and paste it into the Lesson Editor."
				},
			},
			{
				"id": "tCJD0yMAGd",
				"type": "paragraph",
				"data": {
					"text": "Ace It Up automatically detects the video source and embeds it for learners."
				},
			},
